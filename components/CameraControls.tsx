...
export function CameraControls({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg border border-slate-800 bg-slate-900/60 p-4 shadow-lg">
      <div>
        <h2 className="text-lg font-semibold text-slate-50">{t.cameraPanel.title}</h2>
        <p className="text-sm text-slate-400">{t.cameraPanel.description}</p>
      </div>
